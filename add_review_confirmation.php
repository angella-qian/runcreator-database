<?php
    ...
    if ( ( strlen($_POST['comments']) == 0)
        ...
        $sql = "INSERT INTO reviews (routeID, userID, comments, rating, reviewedOn)
                VALUES ($route_id, $user_id, '$comments', $rating, '$reviewed_on');";
...
<div class="wrapper">
    ...
    <nav id="sidebar">
     ...
     <div id="content">
        ...
        <div>
            <h2>Add Review Confirmation Status</h2>
        </div>
        ...
        <div id="DataTables_Table_0_wrapper">
            ...
            <?php else : ?>
                ...
                <div class="text-success">
                    <span class="font-italic">Your review was successfully added.</span>
                </div>
