<?php
	...
	if ( !isset($_GET['route_id']) || empty($_GET['route_id'])
		|| !isset($_GET['rev_id']) || empty($_GET['rev_id'])
	) {
...
<head>
    ...
    <title>Run Creator | Delete Review </title>
...
<div class="wrapper">
    ...
    <nav id="sidebar">
     ...
     <div id="content">
        ...
        <div>
            <h2>Delete Review Confirmation Status</h2>
        </div>
        ...
        <div id="DataTables_Table_0_wrapper">
            ...
            <?php else : ?>
                ...
                <div class="text-success">
                    <span class="font-italic">Your review was successfully deleted.</span>
                </div>

                <div>
                    To see other reviews for the same route, click <a href="details.php?id=<?php echo $route_id; ?>">here</a>.
                </div>
